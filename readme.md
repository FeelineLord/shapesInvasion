<h1> Приветствую! </h1> ShapesInvasion - приложение, которое отобразит на canvas различные геометрические фигуры с возможностью пользовательского взаимодействия: https://feelinelord.github.io/shapesInvasion/
<hr>
